...
1. Ensure Cloudflare auth is available (`wrangler login` locally, or secrets in CI).
2. Apply schema migrations:
   `pnpm wrangler d1 migrations apply venn2meet --remote`
3. Deploy Worker:
   `pnpm deploy`
...
- For GitHub Actions deployment workflow:
